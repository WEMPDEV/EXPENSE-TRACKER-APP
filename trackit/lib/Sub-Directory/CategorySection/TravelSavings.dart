...
class TravelSavings extends StatelessWidget {
  const TravelSavings({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Travel', style: TextStyle(
        ...
        Padding(
          ...
          child: Row(
            children: [
              Column(
                children: [
                  InfoCard(title: "Goals", amount: "\$1,962.30", icon: Icons.vertical_align_top_sharp),
                  SizedBox(height: 10,),
                  InfoCard(title: "Amount Saved", amount: "\$653.53", icon: Icons.vertical_align_bottom_sharp),
                ],
              ),
              SizedBox(width: 30),
              _buildCategoryItem( iconData: Icons.airplanemode_on_sharp, label: 'Travel',)
