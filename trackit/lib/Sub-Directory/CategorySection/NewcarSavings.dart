...
class NewCarSavings extends StatelessWidget {
  const NewCarSavings({super.key});
        ...
        Padding(
            ...
            child: Row(
              children: [
                Column(
                  children: [
                    InfoCard(title: "Goals", amount: "\$14,200.00", icon: Icons.vertical_align_top_sharp),
                    SizedBox(height: 10,),
                    InfoCard(title: "Amount Saved", amount: "\$563.53", icon: Icons.vertical_align_bottom_sharp),
                  ],
                ),
                SizedBox(width: 30),
                _buildCategoryItem( iconData:Icons.car_rental_rounded, label: 'New Car',)
