  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Add Savings', style: TextStyle(
                  ...
                  child: ListView(
                    children: [ Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: DropdownButtonFormField<String>(
                              decoration: InputDecoration(
                                hintText: 'Select Savings Category',
                                labelStyle: theme.textTheme.labelLarge,
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10),borderSide: BorderSide.none,
                                ),
                        ...
                        SizedBox(height: 16),
                        Text('Savings Title',style: TextStyle(
                          fontFamily: 'Nunito',
                          fontSize: 20,
                          color: Theme.of(context).textTheme.bodyLarge!.color,
                        ),),
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child:TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: "e.g house, wedding, travel, car deposits e.t.c",
                                labelStyle: theme.textTheme.labelLarge,
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10),borderSide: BorderSide.none,
                                ),
