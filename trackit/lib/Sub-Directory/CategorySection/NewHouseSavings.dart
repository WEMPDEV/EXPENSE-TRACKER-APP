...
class NewHouseSavings extends StatelessWidget {
  const NewHouseSavings({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('New House', style: TextStyle(
        ...
        Padding(
            ...
            child: Row(
              children: [
                Column(
                  children: [
                    InfoCard(title: "Goals", amount: "\$569,200.00", icon: Icons.vertical_align_top_sharp),
                    SizedBox(height: 10,),
                    InfoCard(title: "Amount Saved", amount: "\$653.53", icon: Icons.vertical_align_bottom_sharp),
                  ],
                ),
                SizedBox(width: 30),
                _buildCategoryItem( iconData:  Icons.house_rounded, label: 'New House',)
